...
const navigation = [
  ...
  { name: 'Approvals', href: '/approvals', icon: ClipboardCheck, hideFor: ['exec', 'super_admin'] },
  { name: 'Reports', href: '/reports', icon: BarChart3, hideFor: ['super_admin'] },
  { name: 'Documents', href: '/documents', icon: FileText, hideFor: ['exec', 'super_admin'] },
  { name: 'Letters', href: '/letters', icon: Mail, hideFor: ['exec', 'super_admin'] },
